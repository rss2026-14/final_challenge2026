...
img=cv2.imread('../../racetrack_images/lane_3/image53.png')
lineimg=cv2.imread('../../racetrack_images/lane_3/image53.png')
...
colormasked = cv2.bitwise_and(hsv, hsv, mask=white_mask)
...
cv2.circle(img, (x_target, y_target), 5, (0, 0, 255), -1)
